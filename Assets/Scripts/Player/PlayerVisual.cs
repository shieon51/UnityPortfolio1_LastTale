...
[DefaultExecutionOrder(20)] // ★ PlayerCombat(-10), PlayerController(기본 0)가 이번 프레임 상태를 다 확정한 뒤, 맨 마지막에 읽고 그리도록 보장
...
public class PlayerVisual : MonoBehaviour
{
    ...
    private void ReconcileStuckState()
    {
        ...
        {
            Debug.LogWarning("[PlayerVisual] 잠금 해제 상태인데 애니메이터가 로코모션이 아님 — 강제 복구합니다.");
            ReturnToLocomotion();
        }
    }
